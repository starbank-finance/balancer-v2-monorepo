...
// export const NETWORKS = ['goerli', 'kovan', 'mainnet', 'rinkeby', 'ropsten', 'polygon', 'arbitrum', 'astar'];
export const NETWORKS = ['opera', 'astar', 'astar2', 'polygon', 'avalanche', 'fuji', 'fantomtest', 'harmony', 'bsc'];
